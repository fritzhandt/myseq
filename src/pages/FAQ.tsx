...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "No, and there are actually no user accounts available. Our website is designed to be a completely open, anonymous resource for community information. You can access all resources and civic information without any registration or sign-up process."
    },
    {
      id: "resource-suggestions", 
      question: "Can I suggest new resources to be added?",
      answer: "Yes! We welcome community input. You can use the 'Contact Us' button at the bottom of this page to suggest new resources, programs, or services that would benefit Southeast Queens residents."
    },
    {
      id: "mobile-app",
    ...
    },
    {
      ...
      answer: "If you experience any technical problems with the website, please use the 'Contact Us' button at the bottom of this page. We work to resolve issues quickly to ensure you have the best experience accessing community information."
    },
    {
      id: "information-accuracy",
      question: "How do I know the information is accurate and up-to-date?",
      answer: "Our platform is built and managed by your local elected officials who work directly with community organizations to ensure accuracy. Resource information is regularly updated, but we recommend verifying details directly with organizations for the most current information."
    }
  ];
